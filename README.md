...
-   Steps:
    1.  Checkout code: copy code from repo to github runner machine using actions/checkout@v2.
    2.  SetupPython: It sets up the Python environment using actions/setup-python@v2 and specifies Python version 3.8.
    3.  